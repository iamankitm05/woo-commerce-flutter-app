...
class HomeScreen extends StatelessWidget {
  ...
  static const List<Map<String, dynamic>> drawerItems1 = [
          ...
          children: [
            ...
            SizedBox(
              ...
              child: UserAccountsDrawerHeader(
                ...
                currentAccountPictureSize: const Size(44, 44),
              ),
            ),
            ...
            Expanded(
              child: ColoredBox(
                ...
                child: ListView(
                  ...
                  children: [
                    // display 1st drawer items
                    ...drawerItems1
                        .map((e) => _buildDrawerItem(e['text'], e['iconData']))
                        .toList(),
                    const Divider(),
                    // display 2nd drawer items
                    ...drawerItems2
                        .map((e) => _buildDrawerItem(e['text'], e['iconData']))
                        .toList(),
                    const Divider(),
                    // display 3rd drawer items
                    ...drawerItems3
                        .map((e) => _buildDrawerItem(e['text'], e['iconData']))
                        .toList(),
                  ],
  ...
  Widget _buildDrawerItem(String text, IconData? iconData) {
    return ListTile(
