...
class AppColors {
  ...
  static const Color green = Color(0xFF00B517);
  ...
  static const Color greenTextColor = green;
  ...
  static const Color activeBorderColor = primary;

  // app bar
  static const Color appBarIconColor = dark;
  static const Color appBarBackgroundColor = Colors.white;
  
  // drawer
  static const Color drawerBackgroundColor = Colors.white;
  static const Color drawerHeaderbackgroundColor = Color(0xFFEFF2F4);

  // border
  static const primaryBorderColor = Color(0xFFDEE2E7);
}